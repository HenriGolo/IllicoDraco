...
export class Main extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('tiles', 'assets/full_tileset.png');
        this.load.tilemapTiledJSON("tilemap", 'assets/tilemap_v2.json');

        this.load.spritesheet('player', 'assets/green_archer.png', { 
      frameWidth: 16, 
      frameHeight: 16, 
    });

    this.load.spritesheet('marmite', 'assets/Objets/marmite.png', { 
      frameWidth: 64, 
      frameHeight: 64, 
    });

    this.load.spritesheet('table', 'assets/Objets/table_de_decoupe.png', { 
      frameWidth: 16, 
      frameHeight: 32, 
    });

    this.load.spritesheet('coffre', 'assets/Objets/coffre.png', { 
      frameWidth: 16, 
      frameHeight: 32, 
    });
    ...
    create() {
        ...
        // tilemap.createLayer(i, "full_tileset", 0, 0);//.setCollisionByProperty({collision : true}); 
        // }
