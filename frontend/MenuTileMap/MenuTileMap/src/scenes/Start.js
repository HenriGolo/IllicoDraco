...
export class Start extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('join', 'assets/Boutons/BiggerButtonRej.png', {
                frameWidth: 128,
                frameHeight: 64
            });

        this.load.image('recette', 'assets/Boutons/BiggerButtonLivreRec.png', {
                frameWidth: 128,
                frameHeight: 64
            });

        this.load.image('bestiaire', 'assets/Boutons/ButtonBestiaire.png', {
                frameWidth: 64,
                frameHeight: 32
            });

        this.load.image('options', 'assets/Boutons/ButtonOptions.png', {
                frameWidth: 64,
                frameHeight: 32
            });
